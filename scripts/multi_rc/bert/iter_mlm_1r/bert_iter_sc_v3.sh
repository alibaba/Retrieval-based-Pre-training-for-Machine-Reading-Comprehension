...
oss_pretrain='bert_iter_mlm_1r/pytorch_model_20000.bin'
...
python main_multirc.py \
   ...
   --output_dir experiments/multi_rc_iter_bert/iter_mcrc_v3_iter_mlm1r_0_w_pt_20k \
   --save_steps -1 \
   --logging_steps 500 \
   --save_metric em0 \
...
python main_multirc.py \
   ...
   --max_seq_length 512 \
   --max_query_length 512 \
   --output_dir experiments/multi_rc_iter_bert/iter_mcrc_v3_iter_mlm1r_0_w_pt_20k_s33 \
   --save_steps -1 \
   --logging_steps 500 \
   --save_metric em0 \
   --warmup_steps 600 --evaluate_during_training --weight_decay 0.01 --max_grad_norm 1.0 \
...
python main_multirc.py \
   ...
   --max_seq_length 512 \
   --max_query_length 512 \
   --output_dir experiments/multi_rc_iter_bert/iter_mcrc_v3_iter_mlm1r_0_w_pt_20k_s57 \
   --save_steps -1 \
   --logging_steps 500 \
   --save_metric em0 \
   --warmup_steps 600 --evaluate_during_training --weight_decay 0.01 --max_grad_norm 1.0 \
...
python main_multirc.py \
   ...
   --max_seq_length 512 \
   --max_query_length 512 \
   --output_dir experiments/multi_rc_iter_bert/iter_mcrc_v3_iter_mlm1r_0_w_pt_20k_s67 \
   --save_steps -1 \
   --logging_steps 500 \
   --save_metric em0 \
   --warmup_steps 600 --evaluate_during_training --weight_decay 0.01 --max_grad_norm 1.0 \
