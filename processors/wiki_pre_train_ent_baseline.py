...
class WikiEntityPreTrainPureProcessor(object):
    r"""
    ...
    reader_name = 'wiki_pre_train_ent_baseline'
    ...
    def data_to_tensors(all_features: List[Dict]):
        ...
        all_pre_answers = torch.zeros((data_num, max_q_sent_num), dtype=torch.long).fill_(-1)
